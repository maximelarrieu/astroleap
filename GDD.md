...
- **Core Mechanics**:
  ...
  - **Win Condition**: Reach and enter the Lunar Lander escape hatch at the far right of the stage.
  - **Loss Condition**: Running out of Astronaut Oxygen/Hearts (3 hits) or falling into the lunar chasm.
